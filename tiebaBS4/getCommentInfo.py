    ...
    def pipelines(self, items):
        ...
        with open(fileName, 'w') as fp:
            for item in items:
                ...
                self.log.info(u'标题为<<%s>>的项输入到%s成功' %(item.title, fileName.decode('GBK')))
...
if __name__ == '__main__':
    url = u'http://tieba.baidu.com/f?kw=%E4%BA%BA%E6%B0%91%E7%9A%84%E5%90%8D%E4%B9%89&ie=utf-8&pn=50'
